...
type browserWorker struct {
	...
	nextCommandID int64
	pendingCmds   *concurrentMap[int64, chan CDPResponse]
}
...
func New() (*Custom, error) {
	...
	go func() {
		...
		_, conn, err := connectToPageTarget(-1, debugBaseURL)
		if err != nil {
...
func newBrowserWorker(id int) (*browserWorker, error) {
	w := &browserWorker{
		id:            id,
		nextCommandID: 1,
		pendingCmds:   newConcurrentMap[int64, chan CDPResponse](),
	}
	...
	w.targetID, conn, err = connectToPageTarget(id, w.debugBaseURL)
	if err != nil {
		w.cmd.Process.Kill()
...
func (w *browserWorker) handleEvent(msg CDPMessage) {
	switch msg.Method {
...
func (w *browserWorker) sendCommand(method string, params interface{}) (*CDPResponse, error) {
